...
namespace ATS_TwoWheeler_Simulator.Adapters
{
    ...
    {
        /// <summary>
        /// Gets the adapter type name (e.g., "Simulator")
        /// </summary>
        ...
        /// <summary>
        /// Get available adapter-specific options
        /// </summary>
    ...
    public abstract class CanAdapterConfig
    {
        ...
        /// </summary>
        public ushort BitrateKbps { get; set; } = 250;
    }

    /// <summary>
    /// Configuration for Simulator CAN adapter
    /// </summary>
    public class SimulatorCanAdapterConfig : CanAdapterConfig
    {
        // Simulator-specific settings can be added here in the future
    }
